...
static tCANMsgObject *psMsgObject[Max_CanHwObjectCount];
...
static Can_ControllerStateType Can_ControllerState[MAX_CONTROLLERS_NUMBER] = {
		CAN_CS_UNINIT };
...
static Can_ControllerStateType Can_ControllerMode [MAX_CONTROLLERS_NUMBER];
/*Description :  variable for interrupt Enable in start mode */
static uint8 uint8_uint8_InterruptEnableInStartMode[MAX_CONTROLLERS_NUMBER];
/*Description :  variable for interrupt Disable in stop mode */
static uint8 uint8_InterruptDisableInStoptMode[MAX_CONTROLLERS_NUMBER];
/*Description :  variable for interrupt Disable counter */
static uint8 uint8_InterruptDisableCounter[MAX_CONTROLLERS_NUMBER];
...
Std_ReturnType Can_GetControllerMode(uint8 Controller,
	...
	if (Controller >= MAX_CONTROLLERS_NUMBER)
	{
