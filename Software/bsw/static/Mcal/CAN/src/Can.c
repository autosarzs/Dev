...
Std_ReturnType Can_SetControllerMode(uint8 Controller,	Can_ControllerStateType Transition)
{
	...
	/* return the value E_OK or E_NOT_OK*/
	return ret;
}
...
Std_ReturnType Can_GetControllerErrorState(uint8 ControllerId, Can_ErrorStateType* ErrorStatePtr)
{
    ...
    shall raise development error CAN_E_PARAM_CONTROLLER and return
    E_NOT_OK.*/
    else if (ControllerId >= MAX_CONTROLLERS_NUMBER)
    {
        Det_ReportError(CAN_MODULE_ID, CAN_INSTANCE_ID, Can_SetControllerMode_Id, CAN_E_PARAM_CONTROLLER);
        ret = E_NOT_OK;
    }
    ...
    the parameter ErrorStatePtr is a null pointer, the function Can_GetControllerErrorState
    shall raise development error CAN_E_PARAM_POINTER and return E_NOT_OK. */
    else if (ErrorStatePtr == NULL_PTR)
    {
        Det_ReportError(CAN_MODULE_ID, CAN_INSTANCE_ID, Can_SetControllerMode_Id, CAN_E_PARAM_POINTER);
        ret = E_NOT_OK;
    }
    else
    {
    ...
    *ErrorStatePtr = Can_ErrorStateType_0;
    return ret;
}
