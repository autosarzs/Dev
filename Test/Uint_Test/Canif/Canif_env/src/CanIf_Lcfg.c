...
{
	{
		0x700,								/* Lower CAN Identifier of a receive CAN L-PDU for identifier range definition */
		0x800								/* Upper CAN Identifier of a receive CAN L-PDU for identifier range definition */
	}
};
...
{
	{       
		STD_OFF,							/*True: Software filtering is enabled False: Software filtering is enabled*/
...
{
	{
		...
		0, //staic					    /* ID mask which denotes relevant bits in the CAN Identifier */
	...
	{
		0x700,							/* CAN Identifier of Receive CAN L-PDUs used by the CAN Interface (physical) */
		0xf00,// dynmic					/* ID mask which denotes relevant bits in the CAN Identifier */
		STANDARD_CAN,					/* states if received Pdu Id is of EXTENDED_CAN, EXTENDED_FD_CAN, EXTENDED_NO_FD_CAN, STANDARD_CAN, STANDARD_FD_CAN or STANDARD_NO_FD_CAN */
		8,								/* The Data Length of the received CAN L-PDU in Bytes */
		1,								/* CAN Identifier of Receive CAN L-PDUs used by the CAN Interface (logical) */
		STD_OFF,						/* Enables and disables the Rx buffering for reading of received L-SDU */
